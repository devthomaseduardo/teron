  ...
  return (
    <main className="auth-shell">
      ...
      <div className="auth-card panel">
        ...
        <p className="body-copy">{isAdmin ? 'Acompanhe diagnósticos, propostas e a operação da TERON.' : 'Acesse seu diagnóstico, proposta e evolução do projeto.'}</p>
        ...
        <div className="auth-switch"><span>{isAdmin ? 'É cliente?' : 'Faz parte da equipe?'}</span><a href={isAdmin ? '/cliente/login' : '/admin/login'}>{isAdmin ? 'Ir para portal do cliente' : 'Ir para acesso administrativo'}</a></div>
      </div>
    </main>
  )
}
